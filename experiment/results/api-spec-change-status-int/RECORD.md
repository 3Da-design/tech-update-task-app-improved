...
|:---------|:---------------|:--------------|:-------------|:-------|:-------|:-----------|:---------|:-----|
| ベースライン | 0/4 | 10 | 0 | 0 | 0 | 0 | 0 | 変更なし（baseline 計測） |
| 更新直後 | 2/4 | 20 | 11 | 65 | 16 | 1 | 0 | PHPUnit 17失敗・Newman 3失敗（テスト・Postman未修正） |
| 修正後 | 0/4 | 30 | 15 | 87 | 38 | 2 | 0 | 主指標: 15 files, +87/-38。Controller 未変更 |
